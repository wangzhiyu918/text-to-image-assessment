...
class LoDa(nn.Module):
    def __init__(
        ...
        **karg,
        ...
        # update cfg
        cfg.model.learner_param.embed_dim = self.vit.embed_dim
        cfg.model.learner_param.interaction_block_num = len(self.vit.blocks)
