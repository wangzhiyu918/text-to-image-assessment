...
resume_from = None
load_from = "pretrained_weights/co-detr-vit-large-coco-instance.pth"
pretrained = None
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
        type=dataset_type,
        ann_file=data_root + 'train/evalmuse_trainval10000_coco_instances_v3.json',
        img_prefix=data_root + 'train/images/',
        pipeline=train_pipeline),),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'val/evalmuse_val1001_coco_instances.json',
        img_prefix=data_root + 'train/images',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'test/evalmuse_test999_coco_instances.json',
...
# custom_hooks = [dict(type='EmptyCacheHook', after_epoch=True, after_iter=False)]
